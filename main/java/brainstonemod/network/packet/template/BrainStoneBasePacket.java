 ...
 * PacketPipeline.
 * 
 * @author <b>BrainStone</b>, adapted code from <b>sirgingalot</b>
 */
public abstract class BrainStoneBasePacket {
	 ...
	 */
	public abstract void generatePacketData(ChannelHandlerContext ctx,
			ByteBuf buffer);
	 ...
	 */
	public abstract void processPacketData(ChannelHandlerContext ctx,
			ByteBuf buffer);
}