...
public class TileEntityBlockBrainLogicBlockRenderer extends bdm
{
  public void a(anq tileentity, double d, double d1, double d2, float f)
  {
    try
    {
      float f1 = 0.01F;
  ...
  private void renderInOutPut(anq tileentity, byte byte0)
  {
