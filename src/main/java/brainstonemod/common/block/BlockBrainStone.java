...
public class BlockBrainStone extends Block {
  ...
  /**
   * Constructor of the block. Registers all properties and sets the id and the material
   *
   * @param flag Is the block powered by Redstone? If true the block does not emit light, if yes it
   *     does
   */
