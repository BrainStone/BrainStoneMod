 ...
 * This class is the printer class for the BrainStoneMod. It contains a lot of static final printing
 * methods, that will print the given object under the right conditions. Exceptions will be thrown
 * here as well.
 *
...
public final class BSP {
  /**
   * A error message addon that is very big, asks the user to send the error log to the mod
   * developer, and contains the email address
   */
  ...
  /** This is the logger for the BSM. Will be initialized in the BrainStone class */
   ...
   * @return If the String is no empty, a new line will be added in front of str
   */
   ...
   *
   * @param obj the objects to be logged
  ...
  /**
   * This logs an error to the console with the normal DEBUG level and appends the errorMessageAddon
   *
   ...
   *
   * @param ex the exception to be logged
   * @param additionalMessage a message appended to the standard error message addon
   * @return Return whether the log was logged or not
   ...
   *
   * @param ex the exception to be logged
   * @return Return whether the log was logged or not printException_noAddon(Level.INFO, Throwable
   *     ex)
  ...
  /**
   * This logs an error to the console with the normal DEBUG level and an additional message
   *
   * @param ex the exception to be logged
   * @param additionalMessage a message put in front of the error log
   * @return Return whether the log was logged or not
  ...
  /**
   * This logs an error to the console with the normal ERROR level and appends the errorMessageAddon
   *
   * @param ex the exception to be logged
   * @return Return whether the log was logged or not
   * @see {@link BSP#logException(Level level, Object... obj)}
  ...
  /**
   * This logs an error to the console with the normal ERROR level and an additional message
   *
   * @param ex the exception to be logged
   * @param additionalMessage a message put in front of the error log
   * @return Return whether the log was logged or not
  ...
  /**
   * This logs an error to the console with the normal FATAL level and appends the errorMessageAddon
   *
   * @param ex the exception to be logged
   * @return Return whether the log was logged or not
   * @see {@link BSP#logException(Level level, Object... obj)}
  ...
  /**
   * This logs an error to the console with the normal FATAL level and an additional message
   *
   * @param ex the exception to be logged
   * @param additionalMessage a message put in front of the error log
   * @return Return whether the log was logged or not
  ...
  /**
   * This logs an error to the console with the normal INFO level and appends the errorMessageAddon
   *
   * @param ex the exception to be logged
   * @return Return whether the log was logged or not
  ...
  /**
   * This logs an error to the console with the normal INFO level and an additional message
   *
   * @param ex the exception to be logged
   * @param additionalMessage a message put in front of the error log
   * @return Return whether the log was logged or not
   ...
   *
   * @param level the level the objects will be logged
   * @param obj the objects to be logged
   * @return Return whether the log was logged or not
   */
  ...
  /**
   * This logs an error to the console with an additional message and the level to be logged
   *
   * @param level the level the objects will be logged
   * @param ex the exception to be logged
   * @param additionalMessage a message appended to the standard error message addon
   ...
   * @return Return whether the log was logged or not
   */
  public static final boolean logException_noAddon(
      Level level, Throwable ex, String additionalMessage) {
   ...
   * @param additionalMessage a message put in front of the error log
   * @return Return whether the log was logged or not
   * @see printException_noAddon(Level.INFO, Throwable ex, String additionalMessage)
   ...
   * Throws a ArithmeticException with the error message addon
   *
   * @param additionalMessage a additional message added after the addon
   */
  ...
  /**
   * Throws a exception with the error message addon and a custom message. This is for all
   * <b><u>non-RuntimeExceptions</u></b>
   *
   * @param exception the exception to throw
   * @param additionalMessage the custom message that will be added
   * @throws E the exception type
   */
  @SuppressWarnings("unchecked")
  public static final <E extends Throwable> void throwException(
      E exception, String additionalMessage) throws E {
    throw (E)
        new Throwable(
            "("
  ...
  /**
   * This logs an error to the console with the normal TRACE level and appends the errorMessageAddon
   *
   * @param ex the exception to be logged
   * @return Return whether the log was logged or not
   * @see {@link BSP#logException(Level level, Object... obj)}
  ...
  /**
   * This logs an error to the console with the normal TRACE level and an additional message
   *
   * @param ex the exception to be logged
   * @param additionalMessage a message put in front of the error log
   * @return Return whether the log was logged or not
  ...
  /**
   * This logs an error to the console with the normal WARN level and appends the errorMessageAddon
   *
   * @param ex the exception to be logged
   * @return Return whether the log was logged or not
   * @see {@link BSP#logException(Level level, Object... obj)}
  ...
  /**
   * This logs an error to the console with the normal WARN level and an additional message
   *
   * @param ex the exception to be logged
   * @param additionalMessage a message put in front of the error log
   * @return Return whether the log was logged or not
