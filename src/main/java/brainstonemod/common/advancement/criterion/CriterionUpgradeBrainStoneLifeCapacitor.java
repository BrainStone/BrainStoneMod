...
public class CriterionUpgradeBrainStoneLifeCapacitor
  ...
  private final Map<PlayerAdvancements, CriterionUpgradeBrainStoneLifeCapacitor.Listeners>
  ...
  public void addListener(
    ...
    CriterionUpgradeBrainStoneLifeCapacitor.Listeners upgradeBrainStoneLifeCapacitor$listeners =
    ...
    if (upgradeBrainStoneLifeCapacitor$listeners == null) {
      upgradeBrainStoneLifeCapacitor$listeners =
          new CriterionUpgradeBrainStoneLifeCapacitor.Listeners(playerAdvancementsIn);
  ...
  @Override
  public CriterionUpgradeBrainStoneLifeCapacitor.Instance deserializeInstance(
      JsonObject json, JsonDeserializationContext context) {
    try {
      BrainStoneLifeCapacitorUpgrade.Upgrade type =
          BrainStoneLifeCapacitorUpgrade.Upgrade.valueOf(
              JsonUtils.getString(json, "type").trim().toUpperCase());
      ...
      throw new JsonSyntaxException(
          "Invalid value for type, expected to be either \"capacity\" or \"charging\"", e);
    }
  }

  public void trigger(
      EntityPlayerMP parPlayer, BrainStoneLifeCapacitorUpgrade.Upgrade type, int level) {
  ...
  public static class Instance extends AbstractCriterionInstance {
    ...
    public Instance(
        ResourceLocation parID, BrainStoneLifeCapacitorUpgrade.Upgrade type, int level) {
      super(parID);
  ...
  static class Listeners {
    ...
    private final Collection<
            ICriterionTrigger.Listener<CriterionUpgradeBrainStoneLifeCapacitor.Instance>>
    ...
    public void trigger(
        EntityPlayerMP player, BrainStoneLifeCapacitorUpgrade.Upgrade type, int level) {
      List<ICriterionTrigger.Listener<CriterionUpgradeBrainStoneLifeCapacitor.Instance>> toGrant =
          new LinkedList<>();

      for (ICriterionTrigger.Listener<CriterionUpgradeBrainStoneLifeCapacitor.Instance> listener :
          listeners) {
