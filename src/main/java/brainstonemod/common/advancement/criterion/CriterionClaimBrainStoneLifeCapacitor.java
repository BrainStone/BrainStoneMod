...
public class CriterionClaimBrainStoneLifeCapacitor
  ...
  private final Map<PlayerAdvancements, CriterionClaimBrainStoneLifeCapacitor.Listeners> listeners =
      Maps.newHashMap();
  ...
  public void addListener(
    ...
    CriterionClaimBrainStoneLifeCapacitor.Listeners claimBrainStoneLifeCapacitor$listeners =
        listeners.get(playerAdvancementsIn);

    if (claimBrainStoneLifeCapacitor$listeners == null) {
      claimBrainStoneLifeCapacitor$listeners =
          new CriterionClaimBrainStoneLifeCapacitor.Listeners(playerAdvancementsIn);
  ...
  @Override
  public CriterionClaimBrainStoneLifeCapacitor.Instance deserializeInstance(
  ...
  static class Listeners {
    ...
    private final Collection<
            ICriterionTrigger.Listener<CriterionClaimBrainStoneLifeCapacitor.Instance>>
    ...
    public void trigger(EntityPlayerMP player) {
      List<ICriterionTrigger.Listener<CriterionClaimBrainStoneLifeCapacitor.Instance>> toGrant =
          new LinkedList<>();

      for (ICriterionTrigger.Listener<CriterionClaimBrainStoneLifeCapacitor.Instance> listener :
          listeners) {
