...
public final class BrainStoneModules {
  ...
  public static final String DEPENDENCIES =
      "after:"
          + BAUBLES_MODID
          + ";after:"
          + BETTER_ADVANCEMENTS_MODID
          + ";after:"
          + CTM_MODID
          + ";after:"
          + DRACONIC_EVOLUTION_MODID
          + ";after:"
          + ENDER_IO_MODID
          + ";after:"
          + EX_NIHILO_ADSCENSIO_MODID
          + ";after:"
          + EXTREME_REACTORS_MODID
          + ";after:"
          + FORESTRY_MODID
          + ";after:"
          + INDUSTRIAL_FOREGOING_MODID
          + ";after:"
          + IMMERSIVE_ENGINEERING_MODID
          + ";after:"
          + JEI_MODID
          + ";after:"
          + JER_MODID
          ...
          + MFR_MODID
          + ";after:"
          + MYSTICAL_AGRICULTURE_MODID
          + ";after:"
          + OVERLORD_MODID
          + ";after:"
          + REDSTONE_ARSENAL_MODID
          + ";after:"
          + TESLA_MODID
          + ";after:"
          + THAUMCRAFT_MODID
          + ";after:"
          + THERMAL_EXPANSION_MODID
          + ";after:"
          + THERMAL_FOUNDATION_MODID
          + ";after:"
  ...
  @Module(
      modid = BAUBLES_MODID,
      name = "Baubles",
      message = "Enabling brainStoneLiveCapacitor in the BELT slot.")
  public static boolean baubles() {
    return testMod(BAUBLES_MODID, BAUBLES);
  }

  @Module(
      modid = BETTER_ADVANCEMENTS_MODID,
      name = "Better Achievements",
      message = "Using custom colors.")
  ...
  @Module(
      modid = DRACONIC_EVOLUTION_MODID,
      name = "Draconic Evolution",
      message = "Balancing and adding recipes.",
      integration = DraconicEvolutionCompat.class)
  public static boolean draconicEvolution() {
    return testMod(DRACONIC_EVOLUTION_MODID, DRACONIC_EVOLUTION);
  }

  @Module(
      modid = ENDER_IO_MODID,
      name = "Ender IO",
      message = "Enabling recipes and armor upgrade.",
      integration = EnderIOCompat.class)
  public static boolean enderIO() {
    return testMod(ENDER_IO_MODID, ENDER_IO);
  }

  @Module(
      modid = ENVIRONMENTAL_TECH_MODID,
      name = "Environmental Tech",
      message = "Adding BrainStone Ore to Void Ore Miner.")
  ...
  @Module(
      modid = EXTREME_REACTORS_MODID,
      name = "Extreme Reactors",
      message = "Adding reactants and interiors.",
      integration = ExtremeReactorsCompat.class)
  public static boolean extremeReactors() {
    return testMod(EXTREME_REACTORS_MODID, EXTREME_REACTORS);
  }

  @Module(
      modid = FORESTRY_MODID,
      name = "Forestry",
      message = "Adding bees and related items.",
      integration = ForestryCompat.class)
  public static boolean forestry() {
    return testMod(FORESTRY_MODID, FORESTRY);
  }

  @Module(
      modid = INDUSTRIAL_FOREGOING_MODID,
      name = "Industrial Foregoing",
      message = "Adding BrainStoneOre to Laser Drill.",
      integration = IndustrialForegoingCompat.class)
  public static boolean industrialForegoing() {
    return testMod(INDUSTRIAL_FOREGOING_MODID, INDUSTRIAL_FOREGOING);
  }

  @Module(
      modid = IMMERSIVE_ENGINEERING_MODID,
      name = "Immersive Engineering",
      message = "Adding recipes.",
      integration = ImmersiveEngineeringCompat.class)
  ...
  @Module(
      ...
      message = "Adding drop and orgen information.",
      integration = JEResourcesCompat.class)
  ...
  @Module(
      modid = MYSTICAL_AGRICULTURE_MODID,
      name = "Mystical Agriculture",
      message = "Adding BrainStone Seeds.",
      integration = MysticalAgricultureCompat.class)
  public static boolean mysticalAgriculture() {
    return testMod(MYSTICAL_AGRICULTURE_MODID, MYSTICAL_AGRICULTURE);
  }

  @Module(
      modid = OVERLORD_MODID,
      name = "Overlord",
      message = "Adding Pulsating BrainStone Augment.",
      integration = OverlordCompat.class)
  public static boolean overlord() {
    return testMod(OVERLORD_MODID, OVERLORD);
  }

  @Module(
      modid = REDSTONE_ARSENAL_MODID,
      name = "Redstone Aresenal",
      message = "Tweaking the Brain Stone Life Capacitor recipe.")
  ...
  @Module(
      modid = THERMAL_EXPANSION_MODID,
      name = "Thermal Expansion",
      message = "Adding recipes and making Brain Stone Life Capacitor harder to craft.",
      integration = ThermalExpansionCompat.class)
  public static boolean thermalExpansion() {
    return testMod(THERMAL_EXPANSION_MODID, THERMAL_EXPANSION);
  }

  @Module(
      modid = THERMAL_FOUNDATION_MODID,
      name = "Thermal Foundation",
      message = "Making Brain Stone Life Capacitor harder to craft.")
  public static boolean thermalFoundation() {
    return testMod(THERMAL_FOUNDATION_MODID, THERMAL_FOUNDATION);
  }

  @Module(
      modid = TINKERS_CONSTRUCT_MODID,
      name = "Tinker's Construct",
      message = "Registering BrainStone materials as tool materials.",
      integration = TinkersConstructCompat.class)
  ...
  private static Set<ModuleInformation> detectAllModules() {
    ...
    Map<String, Field> modidsToFields =
        Arrays.asList(BrainStoneModules.class.getDeclaredFields()).stream()
            ...
            .collect(
                Collectors.toMap(
                    ...
                    field -> {
                      try {
                        return BrainStoneModules.class.getDeclaredField(
