...
public class ExtremeReactorsCompat implements IModIntegration {
	...
	public void init(FMLInitializationEvent event) {
		...
		ReactorConversions.register(REACTANT_ESSENCE_OF_LIFE, REACTANT_BRAINSTONE, ReactorReaction.standardReactivity * 1.25F, ReactorReaction.standardFissionRate * 0.75F);
