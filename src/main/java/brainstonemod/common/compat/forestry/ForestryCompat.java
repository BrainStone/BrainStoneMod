...
public class ForestryCompat implements IModIntegration {
  private static void registerCarpenterRecipes() {
    RecipeManagers.carpenterManager.addRecipe(
        150,
        ItemStack.EMPTY,
        new ItemStack(BrainStoneItems.essenceOfLifeFragment(), 1),
        "DD",
        "DD",
        'D',
  ...
  private static void registerCentrifugeRecipes() {
    RecipeManagers.centrifugeManager.addRecipe(
        20,
        new ItemStack(BrainStoneItems.brainStoneComb()),
        ImmutableMap.of(
            ModuleCore.items.beeswax.getItemStack(),
            1.0f,
            new ItemStack(BrainStoneItems.brainStoneDustTiny()),
            0.9f,
            new ItemStack(BrainStoneItems.brainStoneDustTiny()),
            0.1f,
            new ItemStack(BrainStoneItems.brainStoneDustTiny()),
  ...
  public void preInit(FMLPreInitializationEvent event) {
    ...
    BrainStoneItems.addItem(
        "brain_stone_scoop",
        (new ItemBrainStoneScoop(BrainStoneItems.toolBRAINSTONE))
            .setCreativeTab(Tabs.tabApiculture));
    BrainStoneItems.addItem(
        "stable_pulsating_brain_stone_scoop",
        (new ItemBrainStoneScoop(BrainStoneItems.toolSTABLEPULSATINGBS))
            .setCreativeTab(Tabs.tabApiculture));
  }
