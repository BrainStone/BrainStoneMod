...
public class BeeGenes {
  ...
  public static void intiFlowers() {
    ...
    flowerRegistry.registerAcceptableFlower(
        BrainStoneBlocks.pulsatingBrainStone(), flowerBrainStone);
    flowerRegistry.registerAcceptableFlower(
        BrainStoneBlocks.pulsatingBrainStoneEffect(), flowerBrainStone);
    flowerRegistry.registerAcceptableFlower(
  ...
  public static void intiGenes() {
    flowerTypeBrainStone =
        AlleleManager.alleleFactory.createFlowers(
            BrainStone.MOD_ID,
            "flowers",
            flowerBrainStone,
            getFlowerProvider(flowerBrainStone),
            true,
            new IChromosomeType[] {EnumBeeChromosome.FLOWER_PROVIDER});
    flowerTypeStablePulsatingBrainStone =
        AlleleManager.alleleFactory.createFlowers(
            BrainStone.MOD_ID,
            "flowers",
            flowerStablePulsatingBrainStone,
            getFlowerProvider(flowerStablePulsatingBrainStone),
            true,
            new IChromosomeType[] {EnumBeeChromosome.FLOWER_PROVIDER});
  }
