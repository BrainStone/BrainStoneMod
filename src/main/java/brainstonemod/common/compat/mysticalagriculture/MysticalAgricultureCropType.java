...
public class MysticalAgricultureCropType {
  ...
  public static MysticalAgricultureCropType of(
  ...
  public void addSeedRecipe() {
    ...
    ModRecipes.addShapedRecipe(
        new ItemStack(getSeed()),
        "MEM",
        "ESE",
        "MEM",
        'E',
        ModRecipes.getEssence(getTier()),
        'S',
        ModRecipes.getCraftingSeed(getTier()),
        'M',
        getMaterial());
  }
