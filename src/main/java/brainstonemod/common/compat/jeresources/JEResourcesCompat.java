...
public class JEResourcesCompat implements IModIntegration {
  ...
  public void init(FMLInitializationEvent event) {
    ...
    final LootDrop[] drops =
        new LootDrop[] {
          new LootDrop(brainStoneDust, 0, 1, 1f / 2f, 0),
          new LootDrop(brainStoneDust, 0, 2, 2f / 3f, 1),
          new LootDrop(brainStoneDust, 0, 3, 3f / 4f, 2),
    ...
    jerAPI
        .getMobRegistry()
        .register(
            new EntityWither(world),
            new LootDrop(
                essenceOfLife, (float) BrainStoneConfigWrapper.getEssenceOfLifeBaseChance()));
        ...
        jerAPI
            ...
            .register(
                ...
                new DistributionSquare(
                    ...
                    0,
                    32),
                new Restriction(new DimensionRestriction(dim)),
                true,
                drops);
