...
public class PacketSyncChangeGate implements IMessage {
	private int x;
	private short y;
	private int z;
	...
	public PacketSyncChangeGate() {
	}

	public PacketSyncChangeGate(TileEntity tileentity, String gate, int direction) {
		x=tileentity.xCoord;
	...
	public static class Handler extends AbstractClientMessageHandler<PacketSyncChangeGate> {
		@Override
		public IMessage handleClientMessage(EntityPlayer player, PacketSyncChangeGate message, MessageContext ctx) {
