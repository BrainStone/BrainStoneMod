...
public class BrainStoneItems {
	...
	private static final void createEnums() {
		...
		ItemStack stablePulsatingBrainStone = new ItemStack(BrainStoneBlocks.stablePulsatingBrainStone());
	...
	protected static void generateItems() {
		...
		addItem("brain_stone_dust", (new Item()).setCreativeTab(BrainStone.getCreativeTab(CreativeTabs.MATERIALS)));
		addItem("brain_processor", (new Item()).setCreativeTab(BrainStone.getCreativeTab(CreativeTabs.MISC)));
		...
		addItem("brain_stone_helmet", new ItemArmorBrainStone(armorBRAINSTONE, EntityEquipmentSlot.HEAD));
		addItem("brain_stone_plate", new ItemArmorBrainStone(armorBRAINSTONE, EntityEquipmentSlot.CHEST));
		addItem("brain_stone_leggings", new ItemArmorBrainStone(armorBRAINSTONE, EntityEquipmentSlot.LEGS));
		addItem("brain_stone_boots", new ItemArmorBrainStone(armorBRAINSTONE, EntityEquipmentSlot.FEET));
		...
		addItem("stable_pulsating_brain_stone_shovel", new ItemToolBrainStone(toolSTABLEPULSATINGBS, "spade"));
		addItem("stable_pulsating_brain_stone_pickaxe", new ItemToolBrainStone(toolSTABLEPULSATINGBS, "pickaxe"));
		addItem("stable_pulsating_brain_stone_axe", new ItemToolBrainStone(toolSTABLEPULSATINGBS, "axe"));
		addItem("stable_pulsating_brain_stone_hoe", new ItemHoeBrainStone(toolSTABLEPULSATINGBS));
		addItem("stable_pulsating_brain_stone_helmet",
				new ItemArmorBrainStone(armorSTABLEPULSATINGBS, EntityEquipmentSlot.HEAD));
		addItem("stable_pulsating_brain_stone_plate",
				new ItemArmorBrainStone(armorSTABLEPULSATINGBS, EntityEquipmentSlot.CHEST));
		addItem("stable_pulsating_brain_stone_leggings",
				new ItemArmorBrainStone(armorSTABLEPULSATINGBS, EntityEquipmentSlot.LEGS));
		addItem("stable_pulsating_brain_stone_boots",
