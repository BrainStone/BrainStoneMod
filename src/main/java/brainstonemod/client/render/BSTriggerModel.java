...
public class BSTriggerModel implements IBakedModel {
	...
	/**
	 * return a list of the quads making up the model. We choose the model based
	 * on the IBlockstate provided by the caller.
	 */
	@Override
	...
	/**
	 * This method is used to create a suitable IBakedModel based on the
	 * IBlockState of the block being rendered. If IBlockState is an instance of
	 * IExtendedBlockState, you can use it to pass in any information you want.
	 */
	...
	/**
	 * getTexture is used directly when player is inside the block. The game
	 * will crash if you don't use something meaningful here.
	 */
	@Override
	...
	/**
	 * ideally, this should be changed for different blocks being camouflaged,
	 * but this is not supported by vanilla
	 */
	@Override
