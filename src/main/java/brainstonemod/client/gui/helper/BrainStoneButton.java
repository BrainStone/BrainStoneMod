...
public class BrainStoneButton {
  ...
  public BrainStoneButton(
      int ID, int xSize, int ySize, int xPos, int yPos, int xDownPos, int yDownPos) {
  ...
  public BrainStoneButton changeTriggerBox(
      int triggerXmin, int triggerYmin, int triggerXmax, int triggerYmax) {
