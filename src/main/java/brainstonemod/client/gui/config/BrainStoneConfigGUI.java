...
public class BrainStoneConfigGUI extends GuiConfig {
  public BrainStoneConfigGUI(GuiScreen parent) {
    super(
        parent, getConfigElements(), BrainStone.MOD_ID, false, false, BrainStone.NAME + " Config");
  }
  ...
  private static List<IConfigElement> getConfigElements() {
    ...
    list.add(
        categoryElement(
            BrainStoneConfigWrapper.getModulesCategory(),
            "Modules",
            "gui.brainstone.config.cat.modules"));
    list.add(
        categoryElement(
            BrainStoneConfigWrapper.getMiscCategory(),
            "Miscellaneous",
            "gui.brainstone.config.cat.miscellaneous"));
    list.add(
        categoryElement(
            BrainStoneConfigWrapper.getBrainStoneLifeCapacitorCategory(),
            "BrainStoneLifeCapacitor",
            "gui.brainstone.config.cat.brainstonelifecapacitor"));
    list.add(
        categoryElement(
            BrainStoneConfigWrapper.getWorldgenCategory(),
            "Worldgen",
