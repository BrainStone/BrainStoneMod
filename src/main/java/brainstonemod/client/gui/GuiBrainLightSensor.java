...
public class GuiBrainLightSensor extends GuiBrainStoneBase {
  ...
  /**
   * The temporary storage of the light direction (whether the light level is triggered from the
   * right or the left
   */
  ...
  /**
   * Sets the light level (red bars), updates the TileEntity ,and snycs it with the server.
   *
   * @param i the level to what the light level is going to be set
   */
